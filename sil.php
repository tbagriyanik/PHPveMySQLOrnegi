	...
	<div id="wrapper">
		...
		<div id="main">
			...
			if (isset($_GET["id"]) && $_GET["id"] != "") {
				$sil = mysqli_real_escape_string($baglan, trim($_GET["id"]));
				$sorguSil = mysqli_query($baglan, "DELETE FROM tatilkampanyalar WHERE id=$sil");
				echo $sil . " numaralı kayıt silindi.";
			} else
				$sil = "";

			$sorgu = mysqli_query($baglan, "SELECT * FROM tatilkampanyalar");
				...
				<article class="post">
					<header>
						...
						<div class="meta">
							...
							<a href="sil.php?id=<?php echo $satir["id"]; ?>"><span class="name">✖️ Sil</span></a>
						</div>
					</header>
				</article>
				<?php
